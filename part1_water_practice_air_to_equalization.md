...
This practice comes **after Part 1 and before Part 2**. The goal is not
...
-   **No depth goal.** Quality of movement comes before depth.
-   **Equalize early.** Do not wait for discomfort.
-   **Small and frequent.** Use controlled, economical pressure pulses.
-   **Relaxation first.** Do not compensate for pressure with more
    force.
-   **Stop before pain.** Pain or sharp pressure ends the exercise.
...
The purpose is to eliminate the habit of waiting until pressure becomes
noticeable.

During a shallow descent:

-   Equalize **before** significant pressure is felt.
-   Make the pressure pulse small.
-   Repeat frequently.
...
Perform a shallow descent and deliberately use **less force** than
usual.

If equalization does not happen easily:

1.  Stop descending.
2.  Relax.
3.  Return slightly shallower if necessary.
4.  Reset the tongue/glottis position.
5.  Try again gently.
6.  If it still does not work, terminate the descent.

**Never turn this into a strength exercise.**
...
Repeat shallow descents while paying attention to head position.

Compare, without forcing:

-   neutral head;
-   slightly extended head;
-   slightly flexed head.

The purpose is to discover which position allows the equalization
mechanism to work most naturally.
...
-   neck tension;
-   jaw movement;
-   changes in body position immediately before equalization;
...
Reduce the task. Go back to very shallow water and reproduce the same
tongue/glottis movement without adding depth.

### "I can equalize, but I have to push hard."

Do not increase force. Stop the descent, reset and try shallower. If it
repeatedly requires force, end the exercise and reassess the mechanics.

### "I wait until I feel pressure."

Practise the Equalization Frequency Drill. The objective is to equalize
**before** pressure becomes uncomfortable.

### "My jaw or neck gets tense."

Reduce effort and slow down. Tension is a sign to reassess technique,
not to push harder.

### "One side feels different."

Do not force the asymmetrical side. Return to a comfortable depth and
practise gently. Persistent or painful asymmetry should be assessed by
...
**Descent → pressure changes → early equalization → relaxed
continuation.**

The progression is:

> **Understand the mechanism → reproduce it on land → feel it in shallow
> water → make it frequent → make it effortless → only then add depth.**

**Depth is not the exercise.\
